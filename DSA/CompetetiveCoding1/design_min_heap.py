...
class MinHeap:
    ...
    def isLeaf(self, pos):
        ...
        # Function returns True is the "pos" node
        # is a leaf node
    ...
    def minHeapify(self, pos):
        ...
        if not self.isLeaf(pos):
            if (
                ...
                if (
                    self.Heap[self.leftChild(pos)] < self.Heap[self.rightChild(pos)]
                ):  # if left is smaller than right child
                    self.swap(
                        pos, self.leftChild(pos)
                    )  # swap curr node with left and heapify
    ...
    def insert(self, element):
        ...
        while self.Heap[current] < self.Heap[self.parent(current)]:
            ...
            )  # swap the curr and its parent if parent node value is gt
    ...
    def minHeap(self):
        # Build min heap using minHeapify
    ...
    def remove(self):
        ...
        self.Heap[self.FRONT] = self.Heap[
            self.size
        ]  # put last node to the root value and heapify
        self.size -= 1
